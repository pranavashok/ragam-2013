	...
	<section id="gallery">
		<div class="pe-container">
			<ul id="pe-thumbs" class="pe-thumbs">
				<li><a href="img/photos/1.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/1.jpg" /><div class="pe-description"><h3>Music</h3><p>Dedicated, for its alluring elegance </p></div></a></li>
				<li><a href="img/photos/2.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/2.jpg" /><div class="pe-description"><h3>Ingress</h3><p>Even the wonderland needed an entrance, and here it is!!</p></div></a></li>
				<li><a href="img/photos/3.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/3.jpg" /><div class="pe-description"><h3>Careen</h3><p>Whiles both his youth and virtue did intend</p></div></a></li>
				<li><a href="img/photos/4.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/4.jpg" /><div class="pe-description"><h3>Brilliance</h3><p>He made it possible, its not a virtue, but an achievement</p></div></a></li>
				<li><a href="img/photos/5.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/5.jpg" /><div class="pe-description"><h3>Determination</h3><p>Who has won the battles without a lifetime spoiled in coliseum</p></div></a></li>
				<li><a href="img/photos/6.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/6.jpg" /><div class="pe-description"><h3>Fashion</h3><p>Get lost in the show of elegance</p></div></a></li>
				<li><a href="img/photos/7.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/7.jpg" /><div class="pe-description"><h3>life was graced</h3><p>But his own worth, wherein his life was graced</p></div></a></li>
				<li><a href="img/photos/8.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/8.jpg" /><div class="pe-description"><h3>the same</h3><p>Sith as that ever he maintained the same?</p></div></a></li>
				<li><a href="img/photos/9.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/9.jpg" /><div class="pe-description"><h3>oblivion</h3><p>Oblivion in the darkest day to come</p></div></a></li>
				<li><a href="img/photos/10.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/10.jpg" /><div class="pe-description"><h3>sin shall tread</h3><p>When sin shall tread on merit in the dust</p></div></a></li>
				<li><a href="img/photos/11.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/11.jpg" /><div class="pe-description"><h3>lamentable tomb</h3><p>Cannot rase out the lamentable tomb</p></div></a></li>
				<li><a href="img/photos/12.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/12.jpg" /><div class="pe-description"><h3>short-lived deserts</h3><p>Of his short-lived deserts; but still they must</p></div></a></li>
				<li><a href="img/photos/13.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/13.jpg" /><div class="pe-description"><h3>hearts and memories</h3><p>Even in the hearts and memories of men</p></div></a></li>
				<li><a href="img/photos/14.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/14.jpg" /><div class="pe-description"><h3>respect</h3><p>Claim fit respect, that they, in every limb</p></div></a></li>
				<li><a href="img/photos/15.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/15.jpg" /><div class="pe-description"><h3>comfort</h3><p>Remembering what he was, with comfort then</p></div></a></li>
				<li><a href="img/photos/16.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/16.jpg" /><div class="pe-description"><h3>pattern</h3><p>May pattern out one truly good, by him</p></div></a></li>
				<li><a href="img/photos/17.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/17.jpg" /><div class="pe-description"><h3>truly good</h3><p>For he was truly good, if honest care</p></div></a></li>
				<li><a href="img/photos/18.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/18.jpg" /><div class="pe-description"><h3>harmless conversation</h3><p>Of harmless conversation may commend</p></div></a></li>
				<li><a href="img/photos/19.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/19.jpg" /><div class="pe-description"><h3>recompensed</h3><p>Ill recompensed only in his end</p></div></a></li>
				<li><a href="img/photos/20.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/20.jpg" /><div class="pe-description"><h3>tongue</h3><p>Nor can the tongue of him who loved him least</p></div></a></li>
				<li><a href="img/photos/21.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/21.jpg" /><div class="pe-description"><h3>superlative</h3><p>To one superlative above the rest</p></div></a></li>
				<li><a href="img/photos/22.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/22.jpg" /><div class="pe-description"><h3>steady faith</h3><p>Of many men in steady faith reprove</p></div></a></li>
				<li><a href="img/photos/23.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/23.jpg" /><div class="pe-description"><h3>constant temper</h3><p>His constant temper, in the equal weight</p></div></a></li>
				<li><a href="img/photos/24.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/24.jpg" /><div class="pe-description"><h3>thankfulness</h3><p>Of thankfulness and kindness: Truth doth leave</p></div></a></li>
				<li><a href="img/photos/25.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/25.jpg" /><div class="pe-description"><h3>proof</h3><p>Sufficient proof, he was in every right</p></div></a></li>
				<li><a href="img/photos/26.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/26.jpg" /><div class="pe-description"><h3>thankful</h3><p>As kind to give, as thankful to receive.</p></div></a></li>
				<li><a href="img/photos/27.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/27.jpg" /><div class="pe-description"><h3>curious eye</h3><p>The curious eye of a quick-brained survey</p></div></a></li>
				<li><a href="img/photos/28.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/28.jpg" /><div class="pe-description"><h3>scantly find</h3><p>Could scantly find a mote amidst the sun</p></div></a></li>
				<li><a href="img/photos/29.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/29.jpg" /><div class="pe-description"><h3>too-shortened days</h3><p>Of his too-shortened days, or make a prey</p></div></a></li>
				<li><a href="img/photos/30.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/30.jpg" /><div class="pe-description"><h3>faulty errors</h3><p>Of any faulty errors he had done</p></div></a></li>
				<li><a href="img/photos/31.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/31.jpg" /><div class="pe-description"><h3>spleenful sense</h3><p>Not that he was above the spleenful sense</p></div></a></li>
				<li><a href="img/photos/32.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/32.jpg" /><div class="pe-description"><h3>spite of malice</h3><p>And spite of malice, but for that he had</p></div></a></li>
				<li><a href="img/photos/33.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/33.jpg" /><div class="pe-description"><h3>innocence</h3><p>Warrant enough in his own innocence</p></div></a></li>
				<li><a href="img/photos/34.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/34.jpg" /><div class="pe-description"><h3>nature</h3><p>Against the sting of some in nature bad</p></div></a></li>
				<li><a href="img/photos/35.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/35.jpg" /><div class="pe-description"><h3>absolutely blest</h3><p>Yet who is he so absolutely blest</p></div></a></li>
				<li><a href="img/photos/36.jpg" target="_blank"><img src="<?php echo $subDir; ?>img/thumbs/36.jpg" /><div class="pe-description"><h3>mortal frame</h3><p>That lives encompassed in a mortal frame</p></div></a></li>
			</ul>
		</div>
	</section>
	...
	<div id="support-pane">
		...
		<div id="footer_inner">
			<div id="supportpane_top">
				<div id="ticker">
					<div>Those interested to participate in <strong><a href="<?php echo $subDir; ?>Events/Dance/Choreo_Nite">Choreo Nite</a></strong> and <strong><a href="<?php echo $subDir; ?>Events/General/Couture_Boulevard">Couture Boulevard</a></strong> are to mail their previous performances on or before March 1st</div>
					...
					<div>Those interested to participate in <strong><a href="<?php echo $subDir; ?>Events/Music/Amplified">Amplified</a></strong>, <strong><a href="<?php echo $subDir; ?>Events/Music/Acoustics">Acoustics</a></strong> and <strong><a href="<?php echo $subDir; ?>Events/Music/Swara_Raaga">Swara Raaga</a></strong> are to mail their previous performances on or before March 1st</div>
				</div>
